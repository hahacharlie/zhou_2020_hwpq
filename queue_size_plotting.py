...
def parse_data_from_file(file_path):
    ...
    with open(file_path, "r") as file:
        for line in file:
            ...
            elif "Frequency" in line and "Slice LUTs Util%" in line:
                luts_part = line.split("->")[1].strip().split(" ")[3]
                used_slice_luts.append(float(luts_part))
            elif "Frequency" in line and "Slice Registers Util%" in line:
...
file_path = "/home/charlie/Workspace/pq_research/vivado_dir/zhou_2020_hwpq/zhou_2020_hwpq.logs/pq_analysis_64.txt"
...
# Plotting Frequency vs Used Slice Registers Percent
axs[2, 1].plot(frequencies, used_slice_registers, marker="o")
axs[2, 1].set_xlabel("Frequency (MHz)")
axs[2, 1].set_ylabel("Used Slice Registers Percent (%)")
axs[2, 1].set_title("Used Slice Registers Percent vs Frequency")
axs[2, 1].grid(True)
